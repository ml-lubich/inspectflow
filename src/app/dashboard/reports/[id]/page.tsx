...
import { ArrowLeft, Download, Share2, MapPin, Home, Calendar, User, Mail, Printer } from "lucide-react";
        ...
        <CardContent className="p-6 sm:p-8 space-y-8">
          ...
          <div>
            ...
            <div className="flex gap-6 text-sm">
              <div className="flex items-center gap-2"><User className="w-3 h-3 text-gray-400" />{p.clientName}</div>
              <div className="flex items-center gap-2"><Mail className="w-3 h-3 text-gray-400" />{p.clientEmail}</div>
          ...
          <div className="border-t border-gray-200 pt-8 mt-8">
            <div className="flex justify-between items-end">
              ...
              <div className="text-right text-sm text-gray-500">
                ...
                <p>Report ID: {inspection.id.toUpperCase()}</p>
              </div>
            </div>
          </div>
        </CardContent>
